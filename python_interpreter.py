...
editor.configure(width=180,foreground='white')
code_output.configure(bg='midnight blue')
code_output.insert("1.0","Compiled & Executed code here>>>>>>>>")
code_output.configure(width=180,height=100,foreground='white')
